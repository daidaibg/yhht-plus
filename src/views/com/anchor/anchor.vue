 ...
 * @LastEditTime: 2022-05-20 09:18:20
 * @FilePath: \yhht-ui\src\views\com\button\button.vue
-->
<template>
  <div class="buttons ">
    <h2 id="Anchor锚点">Anchor 锚点</h2>
    ...
    <h3 id="注意">注意</h3>
    <div class="warning">
      <p>锚点链接, 如果是 hash 模式需要加上当前 path</p>
    </div>
    <code-light wrapClass="codes" :text="warnCodeText" code-type="language-xml vue"> </code-light>
    <h3 id="Anchor-Props">Anchor Props</h3>
    <table-param :data="propsData" />
    <h3 id="Anchor-Events">Anchor Events</h3>
    <table-param :data="propsEvent" type="events" />
    <h3 id="AnchorItem-Props">AnchorItem Props</h3>
    <table-param :data="propsItemData" />
...
import { warnCodeText, curporCodeText, propsData, propsEvent, propsItemData,containerCodeText } from "./anchor"
